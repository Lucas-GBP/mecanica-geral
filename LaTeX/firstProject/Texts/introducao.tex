...
É essa situação que será tratada nesse trabalho, uma solução numérica, utilizando uma simulação computacional para resolver um problema que seria muito trabalhoso, ou até impossível, de resolver algebricamente. O problema em questão é o lançamento de um projétil, onde a força de arrasto é dependente da posição, velocidade e do projétil, e a força gravitacional é constante.
